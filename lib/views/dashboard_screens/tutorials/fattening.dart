...
class Fattening extends StatefulWidget {
  Fattening({super.key});

  @override
  State<Fattening> createState() => _FatteningState();
}

class _FatteningState extends State<Fattening> {
